...
public class JSpeechParser implements PsiParser, LightPsiParser {
    ...
    public static boolean SelfIdentHeader(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "SelfIdentHeader"))
            return false;
        boolean r;
        ...
        GeneratedParserUtilBase.exit_section_(b,
                                              l,
                                              m,
                                              SELF_IDENT_HEADER,
                                              r,
    ...
    public static boolean Weight(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "Weight"))
            return false;
    ...
    private static boolean declaration_2(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "declaration_2"))
            return false;
        int c = GeneratedParserUtilBase.current_position_(b);
        while (true) {
            if (!declaration_2_0(b, l + 1)) break;
            if (!GeneratedParserUtilBase.empty_element_parsed_guard_(b,
                                                                     "declaration_2",
                                                                     c)) break;
    ...
    private static boolean declaration_2_0(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "declaration_2_0"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b);
    ...
    static boolean grammar(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "grammar"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b);
    ...
    private static boolean grammar_1(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "grammar_1"))
            return false;
        int c = GeneratedParserUtilBase.current_position_(b);
        while (true) {
    ...
    private static boolean grammar_2(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "grammar_2"))
            return false;
        int c = GeneratedParserUtilBase.current_position_(b);
        while (true) {
    ...
    public static boolean literal(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "literal"))
            return false;
    ...
    public static boolean ruleAlternative(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "ruleAlternative"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b,
                                                          l,
    ...
    private static boolean ruleAlternative_0(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b,
                                                      l,
                                                      "ruleAlternative_0"))
            return false;
        Weight(b, l + 1);
    ...
    public static boolean ruleDefinition(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "ruleDefinition"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b,
                                                          l,
    ...
    private static boolean ruleDefinition_0(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "ruleDefinition_0"))
            return false;
        scope(b, l + 1);
        return true;
    }
    ...
    public static boolean ruleExpansion(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "ruleExpansion"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b,
                                                          l,
    ...
    private static boolean ruleExpansion_1(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "ruleExpansion_1"))
            return false;
        int c = GeneratedParserUtilBase.current_position_(b);
        while (true) {
    ...
    public static boolean rulename(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "rulename"))
            return false;
    ...
    public static boolean scope(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "scope"))
            return false;
        if (!GeneratedParserUtilBase.nextTokenIs(b, "<scope>", PRIVATE, PUBLIC))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b,
                                                          l,
    ...
    public static boolean sequenceElement(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "sequenceElement"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b,
                                                          l,
    ...
    public static boolean subexpansion(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "subexpansion"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b,
                                                          l,
    ...
    private static boolean subexpansion_2(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "subexpansion_2"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b);
    ...
    private static boolean subexpansion_3(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "subexpansion_3"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b);
        r = consumeToken(b, PAREN1);
    ...
    private static boolean subexpansion_4(PsiBuilder b, int l) {
        if (!GeneratedParserUtilBase.recursion_guard_(b, l, "subexpansion_4"))
            return false;
        boolean r;
        Marker m = GeneratedParserUtilBase.enter_section_(b);
