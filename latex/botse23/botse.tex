  ...
  \begin{sidewaystable}
    \resizebox{.48\textwidth}{!}{% <------ Don't forget this %
      \begin{tabular}{c*{8}{R}}
        ...
        \ldots-en-us-0.22       \hspace{10pt} & 0.581 & 0.635 & 0.627 & 0.981 & 0.293 & 0.492 & 0.528 & 0.888\\
        \ldots-en-us-0.22-lgraph\hspace{10pt} & 0.631 & 0.659 & 0.672 & 0.977 & 0.346 & 0.544 & 0.569 & 0.877\\
        \ldots-small-en-us-0.22 \hspace{10pt} & 0.793 & 0.736 & 0.760 & 0.998 & 0.271 & 0.725 & 0.661 & 0.905\\
      \end{tabular}
    }
  \end{sidewaystable}
...
Over 30\% of the plugin page visitors originated from the People's Republic of China, indicating a substantial and potentially underserved vocie programming demographic. This suggests the need to support internationalization and localization, an omission we hope to remedy in a future release.
