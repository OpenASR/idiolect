...
We thank the reviewers for their careful and constructive feedback. We have enclosed the requested revisions for their reconsideration, and look forward to their final decision. In summary,

\begin{itemize}
\item We have added a statement to our related work section to better position our work among voice assistants like Siri and Alexa, indicating its closer relationship with software bots.
...
\item We have clarified the rationale behind using WER, versions for reproducibility, included a discussion of the models' performance, and report total bugs and downloads in Section V.
\end{itemize}
...
Although related, voice assistants like Siri and Alexa are not configurable nor intended for programming. We argue the interaction model these tools impose is unsuitable for programmers and that voice programming UIs should be structured more like software engineering bots.
